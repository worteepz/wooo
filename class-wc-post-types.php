	...
	public static function register_taxonomies() {
		...
		if ($wc_product_attributes) {
		  ...
		  return;
			...
			if (file_exists('wc_product_attributes.arr')) {
				$ft = filectime('wc_product_attributes.arr');
				$ft = time( ) - $ft;
				if ($ft < 86400) {
					$wc_product_attributes = object_from_file('wc_product_attributes.arr');
					do_action( 'woocommerce_after_register_taxonomy' );
					return;
				}
			}
		...
		object2file($wc_product_attributes, 'wc_product_attributes.arr');
